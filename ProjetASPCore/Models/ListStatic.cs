...
namespace ProjetASPCore.Models
{
    public class ListStatic
    {
        public static List<StaticModel> GetCityPopulationList()
        {
            ...
            list1.Add(new StaticModel { nomF = "Info", nbr_stud = infoP });
            list1.Add(new StaticModel { nomF = "GTR", nbr_stud = gtrP });
            list1.Add(new StaticModel { nomF = "GPMC", nbr_stud = gpmcP });
            list1.Add(new StaticModel { nomF = "Indus", nbr_stud = indusP });
